...
class AbstractCheckBoxButton extends AbstractField {
  ...
  @override
  Widget createField(parameters) {
    log(_checkValues.toString(), name: "##Rfmdfksa");
...
class _CustomCheckBoxState extends State<CustomCheckBox> {
  ...
  void initState() {
    ...
    if (widget.parameters.containsKey("value")) {
      ...
      log(valueList.toString(), name: "SELE");
      if (valueList.isNotEmpty) {
        checked.value.addAll(valueList);
        // checked.value.add(widget.checkValues?[widget.index]);
        log(widget.checkValues[widget.index].toString(), name: "CHECKED");
      ...
      log(checked.value.toString(), name: "CHECKED");
    }
  ...
  @override
  Widget build(BuildContext context) {
    log(widget.parameters['image'].toString());
    return ValueListenableBuilder(
...
class _CustomDropdownStateState extends State<CustomDropdownState>
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
        ...
        builder: (context, value, child) {
          log("$value and ${widget.items}", name: "VALUEIS");
