...
class _CreateAdvertisementScreenState extends State<CreateAdvertisementScreen> {
  ...
  Widget getPreview() {
    if (selectedAdvertismentOption?['id'] == 0 ||
      ...
      return Transform.scale(
          scale: 0.8, child: PropertyCardBig(property: widget.proeprty));
            ...
            children: [
              _pickImage.listenChangesInUI(
                (context, image) {
                  ...
                  if (widget.proeprty.titleImage == "") {
                    return UiUtils.getImage(widget.proeprty.titleImage!);
                  }
                  return Image.network(
                    widget.proeprty.titleImage ?? "",
                    fit: BoxFit.cover,
                  );
                },
              ),
 ...
 Future<void>  _createAdvertisment() async {
    ...
    context.read<CreateAdvertisementCubit>().create(
        ...
        propertyId: widget.proeprty.id.toString(),
        packageId: packageId,
        ...
        builder: (context, state) {
          if (state is GetSubsctiptionPackageLimitsSuccess) {
            ...
            isPackageAvailableForAdvertismnet =
                state.packageLimit.totalLimitOfAdvertisement != null;
          }
          if (state is GetSubsctiptionPackageLimitsFailure) {}
          return Padding(
          ...
          builder: (context, state) {
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(UiUtils.getTranslatedLabel(context, "preview"))
                      .size(
                        17,
                      )
      ...
      child: Padding(
          ...
          child: UiUtils.buildButton(
            ...
            buttonColor: index == selectedOption
                ? Theme.of(context).colorScheme.teritoryColor.withAlpha(255)
                : Theme.of(context).colorScheme.teritoryColor.withAlpha(50),
          )));
