...
///Light Theme Colors
///This color format is different, isn't it? .You can use hex colors here also but you have to remove '#' symball and add 0xff instead.
...
const Color teritoryColorDark = Color(0xff53ADAE);
...
extension ColorPrefs on ColorScheme {
  ...
  Color get teritoryColor => _getColor(brightness,
      lightColor: teritoryColor_, darkColor: teritoryColorDark);
  ...
  Color get textColorDark => _getColor(brightness,
      lightColor: textColor, darkColor: textColorDarkTheme);
